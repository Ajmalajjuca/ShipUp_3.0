      ...
      <nav className="bg-white p-4 shadow-sm">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <>
              <button
                className="bg-indigo-900 text-white py-2 px-4 rounded-md hover:bg-indigo-800"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-gray-100 text-indigo-900 w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-200"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="w-4 h-4"
